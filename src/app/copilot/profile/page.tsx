      ...
      <div className="max-w-3xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-[#FDB02F] text-base font-semibold uppercase mt-1">{profile.plan} Plan</p>
          </div>
        </div>

        {/* Profile fields */}
        <div className="bg-[#0D1B4B]/40 border border-white/5 rounded-2xl p-6 space-y-5">
          <h3 className="text-white/60 text-base font-semibold uppercase tracking-wider mb-2">Personal Information</h3>
          ...
          <div>
            <label className="block text-white/40 text-base font-medium mb-2">Clinical Role</label>
        ...
        {/* Password */}
        <div className="bg-[#0D1B4B]/40 border border-white/5 rounded-2xl p-6 space-y-5">
          <h3 className="text-white/60 text-base font-semibold uppercase tracking-wider mb-2">Change Password</h3>
...
function Field({
  ...
  return (
    <div>
      <label className="block text-white/40 text-base font-medium mb-2">{label}</label>
      <div className="relative">
