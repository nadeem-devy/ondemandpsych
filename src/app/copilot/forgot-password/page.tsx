        ...
        <div className="bg-[#0D1B4B]/60 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
          ...
          {step === "otp" && (
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              <div>
                <label className="block text-white/50 text-base font-medium mb-2">Verification Code</label>
                <div className="relative">
                ...
                <p className="text-white/30 text-base mt-2">Check your email for the 6-digit code</p>
              </div>
              <button
                type="submit"
              ...
              <button
                ...
                className="w-full text-white/30 text-base hover:text-white/50 transition-colors"
              >
          ...
          {step === "reset" && (
            <form onSubmit={handleResetPassword} className="space-y-5">
              <div>
                <label className="block text-white/50 text-base font-medium mb-2">New Password</label>
                <div className="relative">
          ...
          {step !== "done" && (
            <div className="mt-6 pt-6 border-t border-white/5 text-center">
              <Link href="/copilot/login" className="inline-flex items-center gap-1 text-white/30 text-base hover:text-white/50 transition-colors">
                <ArrowLeft size={12} />
                Back to Sign In
              </Link>
            </div>
