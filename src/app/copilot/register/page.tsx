      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-[#0D1B4B]/60 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-white/50 text-xl font-medium mb-2">Full Name</label>
            ...
            <div>
              <label className="block text-white/50 text-xl font-medium mb-2">Clinical Role</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-white/50 text-xl font-medium mb-2">Password</label>
              <div className="relative">
