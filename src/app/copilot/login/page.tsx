  ...
  return (
    <div className="min-h-screen bg-[#07123A] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-[#0D1B4B]/60 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-end">
              <Link href="/copilot/forgot-password" className="text-[#FDB02F]/70 hover:text-[#FDB02F] text-xl transition-colors">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-white/20 text-xl mt-6">
