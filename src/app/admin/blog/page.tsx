          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-left text-white/40 text-xl font-medium px-6 py-3">
                  Title
                </th>
                <th className="text-left text-white/40 text-xl font-medium px-6 py-3">
                  Status
                ...
                <th className="text-right text-white/40 text-xl font-medium px-6 py-3">
                  Actions
                </th>
              </tr>
            </thead>
              ...
              {posts.map((post) => (
                ...
                >
                  <td className="px-6 py-4">
                    ...
                    <p className="text-white/30 text-xl mt-0.5">
                      /blog/{post.slug}
                    </p>
                  </td>
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xl font-medium ${
                  ...
                  <td className="px-6 py-4 text-white/40 text-xl">
                    {new Date(
