...
const CATEGORIES = [
  ...
  { value: "BillingOptimizationAndRevenueCycleInPsychiatry", label: "Billing Optimization & Revenue Cycle" },
  ...
  { value: "NeuropsychiatricAndCognitiveDisorders", label: "Neuropsychiatric & Cognitive Disorders" },
  ...
  { value: "PsychotherapyNote", label: "Psychotherapy Note" },
  ...
  { value: "SleepDisordersAndInsomniaManagement", label: "Sleep Disorders & Insomnia Management" },
  ...
  { value: "SubstanceUseDisordersAndDualDiagnosis", label: "Substance Use Disorders & Dual Diagnosis" },
  ...
  { value: "TraumaPTSDAndStressorRelatedDisorders", label: "Trauma, PTSD & Stressor-Related Disorders" },
