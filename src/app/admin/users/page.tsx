  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={handleExportCSV} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-white/70 text-xs font-medium hover:bg-white/10 transition-colors">
          <Download size={14} />
          Export CSV
        </button>
      </div>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <button onClick={() => setShowFilters(!showFilters)} className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border text-xs font-medium transition-colors ${showFilters ? "bg-[#FDB02F]/10 border-[#FDB02F]/20 text-[#FDB02F]" : "bg-white/5 border-white/10 text-white/50 hover:text-white/70"}`}>
          <Filter size={14} />
          Filters
        </button>
      </div>
      ...
      {showFilters && (
        <div className="flex items-center gap-3 mb-4 p-3 rounded-lg bg-white/[0.02] border border-white/5">
          ...
          <select value={planFilter} onChange={(e) => setPlanFilter(e.target.value)} className="px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-white/70 text-xs focus:outline-none">
