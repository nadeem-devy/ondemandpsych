          ...
          {tickets.map((t) => (
            ...
            >
              <div className="flex items-center justify-between mb-1">
                ...
                <span className={`text-base px-2.5 py-1 rounded-full font-semibold ${statusColors[t.status] || statusColors.open}`}>
                  {t.status}
                </span>
              </div>
              ...
              <p className="text-white/15 text-base mt-1">
                    ...
                    {activeTicket.rating && (
                      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/5">
                        ...
                        {activeTicket.ratingFeedback && (
                          <span className="text-base text-white/40 max-w-[200px] truncate" title={activeTicket.ratingFeedback}>
