    ...
    <>
      ...
      <SectionWrapper className="py-16 bg-[#07123A]">
        <article className="mx-auto max-w-3xl px-6">
          {/* Breadcrumb */}
          <div className="flex items-center gap-2 text-xl text-white/30 mb-8">
          ...
          <header className="mb-10">
            {post.category && (
              <span className="text-[#FDB02F] text-xl font-semibold uppercase tracking-wider">
                {post.category}
              </span>
            )}
            ...
            {post.tags && (
              <div className="flex flex-wrap gap-2 mt-4">
                {post.tags.split(",").map((tag) => (
                  <span
                    key={tag.trim()}
                    className="px-2.5 py-1 rounded-full bg-[#FDB02F]/10 text-[#FDB02F] text-lg font-medium"
                  >
                    {tag.trim()}
                  </span>
                ))}
