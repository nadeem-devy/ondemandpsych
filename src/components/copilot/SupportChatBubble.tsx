        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className={`text-lg ${isDark ? "text-white/40" : "text-gray-400"}`}>Online</span>
            </div>
          </div>
        </div>
        <button
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        {showRating ? (
          <div className="flex flex-col items-center justify-center h-full py-6">
            ...
            <p className={`text-xl mb-5 text-center px-6 ${isDark ? "text-white/40" : "text-gray-500"}`}>
            ...
            {/* Rating label */}
            {rating > 0 && (
              <p className={`text-xl font-medium mb-4 ${isDark ? "text-white/50" : "text-gray-500"}`}>
            ...
            <textarea
              ...
              rows={2}
              className={`w-full rounded-xl px-3 py-2 text-xl focus:outline-none resize-none mb-4 ${
                isDark
            ...
            <div className="flex gap-2 w-full">
              <button
                ...
                className={`flex-1 py-2.5 rounded-xl text-xl font-medium transition-colors ${
                  isDark
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-xl font-bold bg-[#FDB02F] text-[#07123A] hover:bg-[#FDAA40] disabled:opacity-30 transition-colors"
              >
          ...
          <div className="py-2">
            <p className={`text-xl font-semibold mb-1 ${isDark ? "text-white/50" : "text-gray-600"}`}>
              How can we help you?
            </p>
            <p className={`text-xl mb-4 ${isDark ? "text-white/25" : "text-gray-400"}`}>
            ...
            <div className="space-y-2">
              {quickTopics.map((topic) => (
                ...
                >
                  ...
                  <span className={`text-xl font-medium ${isDark ? "text-white/70" : "text-gray-700"}`}>
                    {topic.label}
                  </span>
                </button>
              ))}
              ...
              <div key={msg.id}>
                {msg.sender === "system" ? (
                  ...
                  <div className="flex justify-center my-2">
                    <div className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-lg font-medium ${
                      isDark
                  ...
                  <div className={`flex ${msg.sender === "user" ? "justify-end" : "justify-start"}`}>
                    <div
                      className={`max-w-[80%] rounded-2xl px-4 py-2.5 text-xl leading-relaxed ${
                        msg.sender === "user"
                    ...
                    >
                      {msg.sender === "admin" && (
                        <p className={`text-lg font-semibold mb-1 ${isDark ? "text-[#FDB02F]/70" : "text-[#FDB02F]"}`}>
                          Support Team
                        </p>
                      )}
