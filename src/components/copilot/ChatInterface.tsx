    ...
    return (
      <div className="flex-1 flex flex-col min-h-0">
        <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6">
          ...
          <p className={`text-xl sm:text-lg text-center max-w-md mb-6 sm:mb-10 ${isDark ? "text-white/40" : "text-gray-500"}`}>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3 w-full max-w-lg">
            {promptSuggestions.map((s) => (
              ...
              >
                ...
                <p className={`text-xl sm:text-lg font-medium ${isDark ? "text-white/70" : "text-gray-700"}`}>{s.title}</p>
                <p className={`text-lg sm:text-xl mt-1 line-clamp-2 ${isDark ? "text-white/25" : "text-gray-400"}`}>{s.prompt}</p>
              </button>
            ))}
          </div>
        </div>
                ...
                {msg.role === "assistant" && (
                  <div className="flex items-center gap-1 mt-1.5 sm:mt-2 ml-1">
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg text-xl transition-colors ${
                    ...
                    <button
                      ...
                      className={`hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xl transition-colors ${
                        isDark ? "text-white/30 hover:text-white/60 hover:bg-white/5" : "text-gray-400 hover:text-gray-600 hover:bg-gray-100"
                      }`}
                    >
                      <Download size={12} />
            ...
            <div className="flex gap-4">
              ...
              <div className={`rounded-2xl px-5 py-4 ${isDark ? "bg-white/[0.04] border border-white/5" : "bg-white border border-gray-200 shadow-sm"}`}>
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-xl ml-2 ${isDark ? "text-white/20" : "text-gray-400"}`}>Generating clinical response...</span>
                </div>
              </div>
            </div>
          )}
  ...
  return (
    <div className={`shrink-0 p-3 sm:p-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:pb-4 border-t ${isDark ? "border-white/5" : "border-gray-200"}`}>
      <div className="max-w-4xl mx-auto">
        ...
        <p className={`text-center text-lg sm:text-xl mt-2 sm:mt-2.5 ${isDark ? "text-white/30" : "text-gray-500"}`}>
