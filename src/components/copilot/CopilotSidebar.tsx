    ...
    <div className="w-72 bg-[#0A1628] border-r border-white/5 flex flex-col h-full">
      ...
      <div className="px-4 py-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-lg bg-white/5 border border-white/5 text-white/70 text-base placeholder:text-white/20 focus:outline-none focus:border-white/10 transition-colors"
          />
        </div>
      </div>
        ...
        <div className="px-4 pb-3">
          <div className="flex items-center gap-2">
            <input
              ...
              autoFocus
              className="flex-1 px-3 py-1.5 rounded-lg bg-white/5 border border-[#FDB02F]/30 text-white/80 text-base placeholder:text-white/20 focus:outline-none"
            />
            <button
      ...
      <div className="flex-1 overflow-y-auto px-2 pb-2">
                    ...
                    >
                      ...
                      {isEditing ? (
                        <input
                          ...
                          autoFocus
                          className="flex-1 bg-white/5 border border-[#FDB02F]/30 rounded px-2 py-0.5 text-base text-white/80 focus:outline-none"
                        />
                      ) : (
                    ...
                    {folderMenuOpen === folder.id && (
                      <div className="absolute right-0 top-full mt-1 z-50 bg-[#0D1B4B] border border-white/10 rounded-xl shadow-xl py-1 min-w-[160px]">
                        <button
                          ...
                          className="w-full flex items-center gap-2 px-3 py-2 text-base text-white/60 hover:text-white hover:bg-white/5 transition-colors"
                        >
                          <Plus size={12} />
                          New Chat in Folder
                        </button>
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-2 px-3 py-2 text-base text-red-400/70 hover:text-red-400 hover:bg-red-500/5 transition-colors"
                        >
                          <Trash2 size={12} />
                          Delete Folder
                        </button>
        ...
        {chats.length === 0 && folders.length === 0 && (
          <div className="text-center py-12 px-4">
            ...
            <p className="text-white/25 text-base">No conversations yet</p>
      ...
      <div className="border-t border-white/5 p-3">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#FDB02F]/20 to-[#FDB02F]/5 flex items-center justify-center text-[#FDB02F] text-base font-bold">
            {userName?.charAt(0)?.toUpperCase() || "U"}
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-white/70 text-base font-medium truncate">{userName}</p>
          </div>
        </div>
      </div>
    </div>
