      ...
      <div className="grid lg:grid-cols-[1fr_320px] gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-white/30 text-base">/blog/</span>
            <input
              type="text"
              value={slug}
              onChange={(e) => setSlug(e.target.value)}
              className="flex-1 px-3 py-1.5 rounded bg-white/5 border border-white/10 text-white/60 text-base focus:outline-none focus:border-[#FDB02F]/50 transition-colors"
            />
          </div>
          ...
          <div className="bg-[#0D1B4B]/60 border border-white/10 rounded-xl overflow-hidden">
            ...
            {showSeo && (
              <div className="px-4 pb-4 space-y-3 border-t border-white/5 pt-3">
                <div>
                  <label className="flex items-center justify-between text-white/40 text-base mb-1">
                ...
                <div className="mt-3 p-3 rounded-lg bg-white/5 border border-white/5">
                  <p className="text-base text-white/30 mb-2">
                    Google Preview
                  </p>
                  <p className="text-blue-400 text-lg font-medium truncate">
                    {metaTitle || title || "Post Title"}
                  </p>
                  <p className="text-green-400/60 text-base truncate">
                    ondemandpsych.com/blog/{slug || "post-slug"}
                  </p>
                  <p className="text-white/40 text-base mt-1 line-clamp-2">
              ...
              <div className="px-4 pb-4 space-y-3 border-t border-white/5 pt-3">
                ...
                <div className="mt-3 rounded-lg border border-white/10 overflow-hidden">
                  ...
                  <div className="p-3 bg-white/5">
                    ...
                    <p className="text-white text-base font-medium mt-0.5 truncate">
