...
const resources = [
  { href: "/legal/hipaa-compliance", label: "HIPAA Compliance" },
  { href: "/legal/privacy-policy", label: "Privacy Policy" },
  { href: "/legal/terms-conditions", label: "Terms & Conditions" },
  { href: "/legal/data-protection-security", label: "Data Protection" },
...
const defaultSocialLinks: SocialLinks = {
  facebook: "https://web.facebook.com/mtppsychiatry",
  linkedin: "https://www.linkedin.com/in/drtpadder/",
  youtube: "https://www.youtube.com/@OnDemandPsych",
  x: "https://x.com/DrtPadder",
  instagram: "https://www.instagram.com/drtpadder/",
};
...
export async function Footer() {
  const socialLinks = await getSiteSetting<SocialLinks>("social_links", defaultSocialLinks);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex gap-3">
              {socialConfig.map(({ key, Icon, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:border-[#FDB02F]/50 hover:text-[#FDB02F] transition-all"
                >
                  <Icon />
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-lg text-white/50 hover:text-[#FDB02F] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
